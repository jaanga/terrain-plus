...
//				png.data[ pngIndex + 2 ] = (( elevation & 0x0000ff ) );
				...
				png.data[ pngIndex ] = parseInt( elevationHex.substr( 4, 2 ), 16 );
				png.data[ pngIndex + 1 ] = parseInt( elevationHex.substr( 2, 2 ), 16 );
				png.data[ pngIndex + 2 ] = parseInt( elevationHex.substr( 0, 2 ), 16 );
// for pretty
